...
// Browser/client code should use the publishable key. Serverless persistence also
// needs to keep working when only the server-side secret is configured.
// Never expose the secret key to the browser; this module is server-only.
const key = String(
